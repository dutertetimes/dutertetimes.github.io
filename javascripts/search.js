    ...
    $.fn.tipuesearch = function(options) {
        ...
        return this.each(function() {
            ...
            function getTipueSearch(start, replace) {
                ...
                var d = $('#search_input').val().toLowerCase();
                d = $.trim(d);
                d = smartypants(d);
                ...
                if (d.length >= set.minimumLength) {
                    ...
                    if (standard) {
                        ...
                        for (var i = 0; i < tipuesearch_in.pages.length; i++) {
                            var score = 0;
                            var s_excerpt = tipuesearch_in.pages[i].excerpt;
                            var s_content = tipuesearch_in.pages[i].content;
                            for (var f = 0; f < d_w.length; f++) {
                                ...
                                if (tipuesearch_in.pages[i].excerpt.search(pat) != -1) {
                                    var m_c = tipuesearch_in.pages[i].excerpt.match(pat).length;
                                    score += (20 * m_c);
                                }
                                ...
                                if (set.highlightTerms) {
                                    ...
                                    s_excerpt = s_excerpt.replace(patr, "<span class=\"h01\">$1</span>");
                                }
                                ...
                                if (tipuesearch_in.pages[i].content.search(pat) != -1) {
                                    var m_c = tipuesearch_in.pages[i].content.match(pat).length;
                                    score += (20 * m_c);
                                }
                                ...
                                if (set.highlightTerms) {
                                    ...
                                    s_content = s_content.replace(patr, "<span class=\"h01\">$1</span>");
                                }
                                ...
                                if (d_w[f].match('^-')) {
                                    ...
                                    if (tipuesearch_in.pages[i].title.search(pat) != -1 ||
                                        tipuesearch_in.pages[i].excerpt.search(pat) != -1 ||
                                        tipuesearch_in.pages[i].tags.search(pat) != -1 ||
                                        tipuesearch_in.pages[i].content.search(pat) != -1) {
                                        score = 0;
                                    }
                                }
                            }
